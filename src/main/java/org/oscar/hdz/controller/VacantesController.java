...
import org.oscar.hdz.util.Utileria;
...
public class VacantesController {
	...
	public String editar(@RequestParam ("id")int idVacante, Model model) {
		Vacante vacante = serviceVacante.buscarPordId(idVacante);
	...
	public String guardar (Vacante vacante, BindingResult result,
		...
		*/
		//return "vacantes/listaVacantes";
		//post-redirect-get
		//model.addAttribute("msg", "Registro guardado con éxito!");
	...
	public String guardar(@RequestParam("nombre")String nombre,
		...
		//guardar los objecto de tipo vacante
	...
	public String verDetalle(@PathVariable("id") int idVacante,Model model) {
		System.out.println("Vacante = " + serviceVacante.buscarPordId(idVacante));
		model.addAttribute("vacante", serviceVacante.buscarPordId(idVacante));
		return "vacantes/detalle";
	}
	
	@GetMapping("/eliminar")
	//RequestMapping - Vincula los parámetros (Binding)
